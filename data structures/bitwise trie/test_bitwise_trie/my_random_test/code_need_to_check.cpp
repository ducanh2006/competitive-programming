...
int main()
{
    ...
    while(q--)
    {
        ...
        {
            cin >> val;
            res = a.find_max_xor(val);
            if( res == (-1) ) cout << res <<endl;
            else cout << (val^res) <<endl;
        }
        else if( str == "find_by_order" )
        {
            cin >> val;
            cout << a.find_by_order(val) <<endl;
        }
        else if( str == "count" )
        {
            cin >> val;
            cout << a.count(val) <<endl;
        }
        else if ( str == "order_of_key" )
        {
            cin >> val;
            cout << a.order_of_key(val) <<endl;
        }
        else if( str == "erase" )
        {
            cin >> val;
        ...
        {
            cin >> val;
            cout << a.lower_bound(val) <<endl;
        }
        else if( str == "upper_bound" )
        {
            cin >> val;
            cout << a.upper_bound(val) <<endl;
        }
        else if( str == "find_less_or_equal" )
        {
            cin >> val;
            cout << a.find_less_or_equal(val) <<endl;
        }
        else if( str == "find_less" )
        {
            cin >> val;
            cout << a.find_less(val) <<endl;
        }
        else if ( str == "min" )
        {
            cout << a.min()<<endl;
