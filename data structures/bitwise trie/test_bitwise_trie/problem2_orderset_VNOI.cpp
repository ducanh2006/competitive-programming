...
int main()
{
    ...
    while(q--)
    {
        ...
        {
            val -= PLUS;
            ans = trie.find_by_order(val);
            if( ans == (-1) ) cout <<"invalid"<< '\n';
            else cout << (ans - PLUS) << '\n';
        }
        else
        {
            cout << trie.order_of_key(val) << '\n';
...
/*
link submission : https://oj.vnoi.info/src/1891732
link ideone : https://ideone.com/wpNYAh
status : accepted
*/
