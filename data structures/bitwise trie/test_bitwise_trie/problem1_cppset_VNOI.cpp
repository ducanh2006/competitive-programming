...
int main()
{
    ...
    const long long plus_val = (1e9);

    long long res,val;
    char type;
    bitwise_trie<33>trie;
    ...
    while( cin >> type )
    {
        ...
        else if( type == '1' )
        {
            cin >> val;
            val += plus_val;
            if(  trie.count(val) == 0 ) trie.insert(val);
        }
        else if( type == '2' )
        {
            cin >> val;
        ...
        {
            cin >> val;
            if( trie.size() == 0 ) cout <<"empty"<<'\n';
            else
            {
                val +=  plus_val;
                res = trie.upper_bound(val);
                if( res == (-1) ) cout <<"no"<<'\n';
                else cout << ( res - plus_val ) <<'\n';
            }
        }
        ...
        else
        {
            ...
            {
                val +=  plus_val;
                res = trie.find_less_or_equal(val);
                if( res == (-1) ) cout <<"no"<<'\n';
                else cout << ( res - plus_val ) <<'\n';
            }
        }
...
/*
link submission : https://oj.vnoi.info/src/1891664
link ideone :  https://ideone.com/iTcbzx
status : accepted
*/
